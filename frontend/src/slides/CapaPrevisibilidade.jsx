...
export default function CapaPrevisibilidade({ goTo, current, total }) {
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position:'relative', textAlign:'center', padding:'0 10%' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize:'0.8em', color:'var(--navy-light)', fontWeight:500 }}>
              Previsibilidade, Aditivos e Prateleira
            </span>
          </div>
