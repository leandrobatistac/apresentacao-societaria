...
import { TabelaAcumuladoAnual } from '../../components/tabelas'

export default function AcumuladoAnualHistorico({ obras, goTo, current, total }) {
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 9.5, fontWeight: 600, letterSpacing: '.12em', textTransform: 'uppercase', color: 'var(--text-dim)', marginBottom: 3 }}>
            Obras <span style={{ color: 'var(--accent)' }}>›</span> Acumulado Anual e Histórico
          </div>
          <div style={{ fontSize: 20, fontWeight: 700, color: 'var(--navy)', lineHeight: 1 }}>
            {metric === 'geral' ? 'Acumulado Anual e Histórico (Geral)' : 'Acumulado Anual e Histórico (% Poros)'}
          </div>
        </div>
