...
import { Sep, Dropdown, DropItem, DropGroupLabel, DropActions, DropScrollBody } from '../../components/Filtros'
import { TabelaPrevisibilidade2027 } from '../../components/tabelas'

export default function Previsibilidade2027({ obras, goTo, current, total }) {
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize:9.5, fontWeight:600, letterSpacing:'.12em', textTransform:'uppercase', color:'var(--text-dim)', marginBottom:3 }}>
            Obras <span style={{ color:'var(--accent)' }}>›</span> Backlog 2027
          </div>
